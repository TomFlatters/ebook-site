      ...
      <div className="row">
        <div className="panel">
          ...
          <div className="p-text">
              ...
              <em>Who are we?</em>
              <br/>
              We are 4 Oxford undergraduates who have all had experience in self-studying for exams. And we're
              all a bit different: Peter studies PPE, Tejas does Physics, Scarlett reads English and I (Tom) study Materials Science.
              </p><p>
              We hope our breadth of subjects and experiences in learning them means we can offer something to everyone.
              </p>
          </div>
          <div className="email-form">
            <p><strong>If you're interested, please submit your email below </strong></p>
